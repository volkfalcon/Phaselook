    ...
    render() {
        ...
        return (
            ...
            <div className="posts mt-3 text-center" id="accordion-post">
                <a data-toggle="collapse" onClick={this.visibleToggle.bind(this)} href={"#collapse-post" + this.props.user.id} role="button" aria-expanded="false" aria-controls={"collapse-post" + this.props.user.id} data-parent="#accordion-post">
